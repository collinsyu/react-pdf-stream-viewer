...
var _header = require("./header.less");
...
var Container = function (_PureComponent) {
    ...
    function Container(props) {
        ...
        _this.download = function () {
            ...
            console.log(_this.props.filePath);
        };
        return _this;
    }
    ...
    _createClass(Container, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement("div", { className: _header2.default.toolbarContainer, ref: function ref(header) {
                    return _this2.header = header;
                } }, _react2.default.createElement("div", { className: _header2.default.toolbar }, _react2.default.createElement("div", { className: _header2.default.aligner }, _react2.default.createElement("span", { className: _header2.default.title }, "text-est.pdf"), _react2.default.createElement(_pagination2.default, { renderPDfByPage: renderPDfByPage, total: total, current: current }), _react2.default.createElement("div", { className: _header2.default.buttons }, _react2.default.createElement(_Icons2.default, { type: "roate-right", onClick: roate }), _react2.default.createElement(_Icons2.default, { type: "file-download", onClick: this.download }), _react2.default.createElement(_Icons2.default, { type: "print", onClick: function onClick() {
                    return console.log("rotae click");
