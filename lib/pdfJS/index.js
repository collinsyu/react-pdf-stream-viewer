...
var PDFView = function (_Component) {
    ...
    function PDFView(props) {
        ...
        _this.setStaticZoom = function () {
            ...
            console.log("⚠️⚠️⚠️⚠️这里应该只执行一次", _this.staticZoomWidth, _this.staticZoomHeight);
        };
    ...
    _createClass(PDFView, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement("div", { className: "pdfViewerContainer" }, _react2.default.createElement(_Header2.default, { filePath: filePath, renderPDfByPage: this.renderPDfByPage, pageProps: pageProps, roate: this.roate, process: process, show: showToolbar }), _react2.default.createElement(_Zoom2.default, { show: showZoombar, screenType: screenType, fullscreen: this.fullscreen, handleZoom: this.handleZoom }), _react2.default.createElement(_Viewer2.default, { handleZoom: this.handleZoom }));
        }
    }]);
