    ...
    function PDFView(props) {
        ...
        _this.handleMouseMove = function (e) {
            ...
            var showZoombar = (0, _toolbar.isMouseNearSideToolbar)({
                ...
                x: e.x + window.innerWidth - _this.container.offsetWidth
    ...
    _createClass(PDFView, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement("div", { className: "pdfViewerContainer", ref: function ref(container) {
                ...
                } }, _react2.default.createElement(_Header2.default, { filePath: filePath, renderPDfByPage: this.renderPDfByPage, pageProps: pageProps, roate: this.roate, process: process, show: showToolbar }), _react2.default.createElement(_Zoom2.default, { show: showZoombar, screenType: screenType, fullscreen: this.fullscreen, handleZoom: this.handleZoom }), _react2.default.createElement(_Viewer2.default, { handleZoom: this.handleZoom }));
        }
    }]);
