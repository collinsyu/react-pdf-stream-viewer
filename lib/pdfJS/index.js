...
var PDFView = function (_Component) {
    ...
    function PDFView(props) {
        ...
        _this.handleMouseMove = function (e) {
            // 判断 当前bar状态 和 距离
            var showToolbar = (0, _toolbar.isMouseNearTopToolbar)(e);
            _this.isMouseNearTopToolbar_ = showToolbar;
            var showZoombar = (0, _toolbar.isMouseNearSideToolbar)(e, _this.window_, _this.reverseSideToolbar_);
        ...
        _this.renderPDfByPage = function (props, screenType, callback) {
            ...
            pdf.getPage(pageNumber).then(function (page) {
                ...
                if (zoom == 1) {
                    ...
                    _self.staticZoomWidth = container.offsetWidth / canvas.width;
                    _self.staticZoomHeight = (container.offsetHeight - 60) / canvas.height;
                }
    ...
    _createClass(PDFView, [{
        ...
        value: function componentWillUnmount() {
            ...
            document.removeEventListener('mousemove', function (e) {
                return _this2.handleMouseEvent_(e);
            });
        }
    }, {
        ...
        value: function componentDidMount() {
            ...
            document.addEventListener('mousemove', function (e) {
                return _this3.handleMouseEvent_(e);
            });
        ...
        value: function render() {
            ...
            return _react2.default.createElement("div", { className: _index2.default.pdfViewerContainer }, _react2.default.createElement(_Header2.default, { filePath: filePath, renderPDfByPage: this.renderPDfByPage, pageProps: pageProps, roate: this.roate, process: process, show: showToolbar }), _react2.default.createElement(_Zoom2.default, { show: showZoombar, screenType: screenType, fullscreen: this.fullscreen, handleZoom: this.handleZoom }), _react2.default.createElement(_Viewer2.default, null));
        }
    }]);
